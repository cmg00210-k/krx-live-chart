...
> **[2026-03-26 갱신]** Phase G (커밋 be27600)에서 Holm step-down → Benjamini-Hochberg step-up FDR로 전환.
> 이유: 195개 검정(39패턴×5기간)에서 BH-FDR의 검정력(power)이 우수하고, 개별 패턴 거짓양성 위험보다
> 전체 시스템의 탐지율 확보가 더 중요하다는 실증적 판단. 구현: backtester.js `_applyBHFDR()`, q=0.05.

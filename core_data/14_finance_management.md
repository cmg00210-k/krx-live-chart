...
## 4. 자금 관리와 포지션 사이징 (Money Management & Position Sizing)

### 4.1 켈리 기준 (Kelly Criterion)
...
### 4.3 고정 비율 포지션 사이징 (Fixed Fractional Position Sizing)
...
### 4.5 최대 낙폭 제약 (Maximum Drawdown Constraints)
...
## 5. 위험 관리 체계 (Risk Management Framework)

### 5.1 전사적 위험관리 (Enterprise Risk Management, ERM)
...
### 5.2 VaR 한도와 포지션 한도 (VaR Limits & Position Limits)
...
## 6. 성과 측정 (Performance Measurement)

### 6.1 샤프 비율 (Sharpe Ratio)
...
### 6.6 성과 귀인 분석 (Performance Attribution — Brinson Model)

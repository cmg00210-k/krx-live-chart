...
## 6. 고급 기법 (Advanced Techniques)

### 6.1 다중 에이전트 강화학습 (Multi-Agent RL)
...
### 6.2 역강화학습 (Inverse Reinforcement Learning)
...
### 6.3 메타 학습 (Meta-Learning for Market Regime Adaptation)
...
### 6.4 모델 기반 강화학습 (Model-Based RL with World Models)
...
### 6.5 안전 강화학습 (Safe RL with Constraints)

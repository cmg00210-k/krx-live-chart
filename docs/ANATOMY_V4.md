...
> 작성일: 2026-04-04 | 6-Agent Parallel Audit 기반 전체 파이프라인 해부도
...
### 5.2 9-Layer Confidence Adjustment (appWorker.js)
...
④ _applyMacroConfidenceToPatterns()    ← 10-factor macro (IS-LM, yield curve,
                                          ...
                                          clamp [0.70, 1.25]
⑤ _applyMicroConfidenceToPatterns()    ← Amihud ILLIQ, HHI concentration
                                          clamp [0.80, 1.15]
